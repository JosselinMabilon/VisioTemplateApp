...
class ConfirmRegisterFragment : Fragment() {
    ...
    fun SetTitle() {
        Text(
            text = stringResource(id = R.string.register_confirmation_email),
    ...
    fun SetEmailMsg() {
        Text(
            text = stringResource(id = R.string.register_email_send_msg),
            modifier = Modifier.padding(
    ...
    fun SetBackToLoginButton() {
        CustomOutlinedButton(
            onClick = { findNavController().navigate(R.id.action_confirmRegisterFragment_to_loginFragment) },
